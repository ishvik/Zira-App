...
function loadTickets(priority) {
    ...
    if (allTaskData != null) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            // let bc = document.getElementsByClassName("ticket");
            // ticket.style.border-left = "2px"+" "+"solid"+" "+selectedPriority;
    ...
    if (!modalVisible) {
        ...
        modal.innerHTML = `<div class="task-to-be-added" spellcheck="false" data-type="false" contenteditable="true">
                    ...
                    <div class="priority-list">
                        <div class="brown-modal-filter modal-filter active"></div>
                        <div class="choclate-modal-filter modal-filter"></div>
                        <div class="green-modal-filter modal-filter"></div>
                        <div class="yellow-modal-filter modal-filter"></div>
                    </div>`;
        TC.appendChild(modal);
        selectedPriority = "brown";
